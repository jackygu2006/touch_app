...
public class OkHttpClientBuilderAdapter implements HttpClientBuilder {
    ...
    /** DeepSeek Context Cache 是否启用 */
    private boolean deepseekCacheEnabled = false;
    ...
    public OkHttpClientBuilderAdapter setDeepseekCacheEnabled(boolean enabled) {
        this.deepseekCacheEnabled = enabled;
        return this;
    }
    ...
    public HttpClient build() {
        ...
        if (deepseekCacheEnabled) {
            builder.addInterceptor(new DeepSeekCacheInterceptor());
        }

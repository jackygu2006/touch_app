...
import com.nextflow.nftouch.agent.langchain.LangChain4jToolBridge
import com.nextflow.nftouch.agent.llm.LlmClient
import com.nextflow.nftouch.agent.llm.LlmClientFactory
import com.nextflow.nftouch.agent.llm.LlmResponse
import com.nextflow.nftouch.agent.llm.StreamingListener
import com.nextflow.nftouch.service.ClawAccessibilityService
import com.nextflow.nftouch.tool.ToolRegistry
import com.nextflow.nftouch.tool.impl.GetScreenInfoTool
...
class DefaultAgentService : AgentService {
    ...
    companion object {
        ...
        /** Max retries on LLM API call failure */
        private const val MAX_API_RETRIES = 3
        /** Infinite loop detection: sliding window size */
        private const val LOOP_DETECT_WINDOW = 4

        /** Whether to write raw network request/response data to sandbox cache file for debugging */
        @JvmField

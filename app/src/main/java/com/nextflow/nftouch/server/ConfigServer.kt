package com.nextflow.nftouch.server
...
/**
 * LAN HTTP config server
 * Provides a web page for configuring LLM from a PC browser.
 */
class ConfigServer(
    ...
    private fun handleGetScreenFull(): Response {
        val service = com.nextflow.nftouch.service.ClawAccessibilityService.getInstance()
            ?: return corsResponse(
                newFixedLengthResponse(

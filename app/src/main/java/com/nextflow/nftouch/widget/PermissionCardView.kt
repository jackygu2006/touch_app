...
class PermissionCardView @JvmOverloads constructor(
    ...
    init {
        radius = dpToPx(12f).toFloat().toFloat()
        cardElevation = 0f
        strokeWidth = dpToPx(1f)
        strokeColor = ContextCompat.getColor(context, R.color.colorBorderHigh)
        setCardBackgroundColor(ContextCompat.getColor(context, R.color.colorBgPrimary))

...
class InputDialog private constructor(context: Context) : BottomSheetDialog(context) {
    ...
    private var onDialogComplete: ((InputDialog, String) -> Unit)? = null
    ...
    companion object {
        ...
        fun show(
            ...
            onDialogComplete: ((InputDialog, String) -> Unit)? = null,
            onCancel: (() -> Unit)? = null,
    ...
    private fun initViews(view: View) {
        ...
        val btnCancel = view.findViewById<KButton>(R.id.btnCancel)
        val btnSpacer = view.findViewById<View>(R.id.btnSpacer)
    ...
    private fun performConfirm(etInput: EditText) {
        ...
        inputValidate?.let { validate ->
            ...
            onDialogComplete?.invoke(this, text)

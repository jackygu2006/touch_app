...
android {
    namespace = "com.nextflow.nftouch"
    compileSdk = 36

    signingConfigs {
        // Debug signing with project-local keystore
        getByName("debug") {
        ...
        // Release signing only if keystore configured in local.properties
    ...
    defaultConfig {
        applicationId = "com.nextflow.nftouch"
        minSdk = 28
        targetSdk = 36
        versionCode = 26071712
        versionName = "2026.7.17.12"
    ...
    onVariants { variant ->
        variant.outputs.forEach { output ->
            if (output is com.android.build.api.variant.impl.VariantOutputImpl) {
                ...
                val fileName = "NF Touch_v${versionName}_${getDateTime()}.apk"
